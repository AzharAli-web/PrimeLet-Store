...
export const dummyproducts = [
  ...
  // Mice (ID 16 to 20)
  {
    ...
    description:
      "Precision wireless Mice designed for gamers with ultra-low latency and ergonomic design.",
    price: 120,
    offerPrice: 100,
  ...
  },
  {
    ...
    description:
      "An ergonomic wireless Mice designed for comfort and long hours of usage.",
    price: 90,
    offerPrice: 85,
  ...
  {
    id: "18",
    name: "RGB Gaming Mice",
    description:
      "Customizable RGB gaming Mice with advanced sensor technology and programmable buttons.",
    price: 40,
    offerPrice: 35,
  ...
  {
    id: "19",
    name: "Wireless Mice with USB Receiver",
    description:
      "Reliable wireless Mice with a USB receiver, ideal for everyday tasks.",
    price: 40,
    offerPrice: 35,
  ...
  {
    id: "20",
    name: "Bluetooth Multi-Device Mice",
    description:
      "Bluetooth Mice that can easily switch between multiple devices, perfect for multitaskers.",
    price: 80,
    offerPrice: 70,
